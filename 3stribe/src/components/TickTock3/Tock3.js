...
gameOver = (event) => {
  ...
  if (fieldPlusFour !== undefined && fieldPlusFour.fieldSign === currentField.fieldSign && fieldPlusFour.column === currentField.column+1 && fieldPlusFour.row === currentField.row+1 && 
    ...
    if (fieldPlusTwo !== undefined && fieldPlusTwo.fieldSign === currentField.fieldSign && fieldPlusTwo.column === currentField.column-1 && fieldPlusTwo.row === currentField.row+1 && 
    fieldPlusFour !== undefined && fieldPlusFour.fieldSign === currentField.fieldSign && fieldPlusFour.column=== currentField.column-2 && fieldPlusFour.row === currentField.row +2) {
      this.setState({gameOver: true})
      this.updateScore()
   } 
   
   else if (fieldPlusTwo !== undefined && fieldPlusTwo.fieldSign === currentField.fieldSign && fieldPlusTwo.column === currentField.column-1 && fieldPlusTwo.row === currentField.row+1 && 
    fieldSubTwo !== undefined && fieldSubTwo.fieldSign === currentField.fieldSign && fieldSubTwo.column=== currentField.column+1 && fieldSubTwo.row === currentField.row -1) {
      this.setState({gameOver: true})
      this.updateScore()

    } 
    
    else if (fieldSubTwo !== undefined && fieldSubTwo.fieldSign === currentField.fieldSign && fieldSubTwo.column === currentField.column+1 && fieldSubTwo.row === currentField.row-1 && 
        fieldSubFour !== undefined && fieldSubFour.fieldSign === currentField.fieldSign && fieldSubFour.column=== currentField.column+2 && fieldSubFour.row === currentField.row -2) {
          this.setState({gameOver: true})
          this.updateScore()
